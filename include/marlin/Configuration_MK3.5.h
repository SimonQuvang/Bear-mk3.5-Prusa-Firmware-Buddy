 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT_E0 3152 // 95% of the original 280 to account for normalised flow
#define DEFAULT_AXIS_STEPS_PER_UNIT \
    { 1600, 1600, 3200, DEFAULT_AXIS_STEPS_PER_UNIT_E0 }
/**
